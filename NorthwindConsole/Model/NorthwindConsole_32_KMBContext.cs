...
{
    public partial class NorthwindConsole_32_KMBContext : DbContext
    {
        public NorthwindConsole_32_KMBContext()
        {
        }

        public NorthwindConsole_32_KMBContext(DbContextOptions<NorthwindConsole_32_KMBContext> options)
            : base(options)
        {
        }
